...
def main():
    ...
    parser.add_argument(
        "--clock_rate_min", type=int, default=1, help="Minimum clock rate"
    )
    parser.add_argument(
        "--clock_rate_max", type=int, default=6, help="Maximum clock rate"
    )
    parser.add_argument(
        "--internal_work_prob",
        type=float,
        default=0.4,
        help="Probability of performing internal work",
    )
